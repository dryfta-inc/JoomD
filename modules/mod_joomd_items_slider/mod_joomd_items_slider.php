...
$doc->addScript(JURI::root().'modules/mod_joomd_items_slider/js_css/jquery-wt-scroller.js');
$doc->addScript(JURI::root().'modules/mod_joomd_items_slider/js_css/scroller.js');

$doc->addStyleSheet(JURI::root().'modules/mod_joomd_items_slider/js_css/wt-lightbox.css');
$doc->addStyleSheet(JURI::root().'modules/mod_joomd_items_slider/js_css/wt-scroller.css');

$typeid = (int)$params->get('typeid', 1);

$type = modJoomd_items_sliderHelper::getType($typeid);

if(empty($type))	{
	$items = array();
}
else	{
	$items = modJoomd_items_sliderHelper::getItems($type, $params);
...
require(JModuleHelper::getLayoutPath('mod_joomd_items_slider'));