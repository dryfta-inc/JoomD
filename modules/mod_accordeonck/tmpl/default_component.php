...
if ($item->deeper AND $params->get('eventtarget') == 'link') {
    ...
    if ($params->get('eventtype', 'click') == 'click') 
...
echo $imageevent; ?><a <?php echo $class; ?>href="<?php echo $item->flink; ?>" target="_blank" <?php echo $title.$style; ?>><?php echo $linktype; ?></a><?php
	...
	case 2:
	// window.open
echo $imageevent; ?><a <?php echo $class; ?>href="<?php echo $item->flink; ?>" onclick="window.open(this.href,'targetWindow','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes');return false;" <?php echo $title.$style; ?>><?php echo $linktype; ?></a>
<?php
		break;
endswitch;
