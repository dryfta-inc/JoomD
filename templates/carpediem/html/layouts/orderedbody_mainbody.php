                        ...
                        <?php else: ?>
                            <div class="<?php echo $mbClasses; ?>">
                                ...
                                <?php endif; ?>
                                       ...
                                       <?php if (isset($fparams->seconcontentBottom)) : ?>
                        <div id="rt-content-bottom-tow">
                            <?php echo $fparams->seconcontentBottom;?>
                        </div>
                        <?php endif; ?>
                            </div>
                        <?php endif; ?>
