...
(function ($) {
    ...
    $.widget('blueimpUI.fileupload', $.blueimp.fileupload, {
        ...
        options: {
			...
			buttonbar: 'fileupload-buttonbar',
			inputbutton: 'fileinput-button',
			filelist: 'fileupload-content',
                    ...
                    data.context.each(function (index) {
                        $(this).fadeOut(function () {
                            if (data.errorThrown !== 'abort') {
								...
								files_to_upload.splice(data.context.num, 1);
                                data.context.remove();
                            }
                        });
                    });
                ...
                if (data.url) {
                    $.ajax(data)
                        .success(function (data, textStatus, jqXHR) {
							//edited for delete result tracking
        ...
        _initFileUploadButtonBar: function () {
            var fileUploadButtonBar = this.element.find('.'+this.options.buttonbar),
                filesList = this.element.find('.files'),
                ns = this.options.namespace;
            fileUploadButtonBar
                .addClass('ui-widget-header ui-corner-top');
            this.element.find('.'+this.options.inputbutton).each(function () {
        ...
        _destroyFileUploadButtonBar: function () {
            this.element.find('.'+this.options.buttonbar)
            ...
            this.element.find('.'+this.options.buttonbar+' button')
                .unbind('click.' + this.options.namespace)
                .button('destroy');
        },

        _enableFileInputButton: function () {
            this.element.find('.'+this.options.inputbutton+' input:file:disabled')
                .each(function () {
                    var fileInput = $(this),
        ...
        _disableFileInputButton: function () {
            this.element.find('.'+this.options.inputbutton+' input:file:enabled')
                .each(function () {
                    var fileInput = $(this),
                        button = fileInput.parent();
        ...
        _create: function () {
            ...
            this.element.find('.'+this.options.filelist)
        ...
        enable: function () {
            ...
            this.element.find(':ui-button').not('.'+this.options.inputbutton)
                .button('enable');
            this._enableFileInputButton();
        },
