...
<form action="index.php?option=com_joomd&view=type" method="post" name="adminlist">
...
<?php $ordering = ($this->lists['order'] == 'i.ordering'); ?>
	...
	<thead>
			...
			<th align="left">
				<?php echo JHTML::_('jdgrid.sort', JText::_('TYPE'), 'i.name', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
			</th>
            <th align="left" width="100">
				<?php echo JHTML::_('jdgrid.sort', JText::_('APP'), 'a.label', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
			</th>
	...
	<tfoot>
		<tr><td colspan="7"><div class="pagination" style="display:<?php echo $dis; ?>"><?php echo JHTML::_('jdgrid.loadmore', JText::_('LMORE'), $this->params->total, count($this->items) ); ?></div></td></tr>
	</tfoot>
