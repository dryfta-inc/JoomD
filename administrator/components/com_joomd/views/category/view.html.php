...
class JoomdViewCategory extends JView
{
    ...
    function display($tpl = null)
    {
		...
		if(JRequest::getCmd('layout', '') == 'form')	{
			...
			if($isNew)	{
				$this->toolbarTitle = $toolbar->evtitle( JText::_( 'NEWCAT' ), 'category.png' );
			}
			else	{
				$this->toolbarTitle = $toolbar->evtitle( JText::_( 'EDITCAT' ), 'category.png' );
			...
			$toolbar->title( JText::_( 'CATMANAGER' ), 'category.png' );
