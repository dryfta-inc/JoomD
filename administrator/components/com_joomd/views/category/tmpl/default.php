...
<form action="index.php?option=com_joomd&view=category" method="post" name="adminlist">
...
<?php $ordering = ($this->lists['order'] == 'i.ordering'); ?>
	...
	<thead>
			...
			<th align="left">
				<?php echo JHTML::_('jdgrid.sort', JText::_('CATEGORY'), 'i.name', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
			</th>
