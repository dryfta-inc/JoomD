...
<form action="index.php?option=com_joomd&view=packages" method="post" name="adminlist">
...
<?php $ordering = ($this->lists['order'] == 'i.ordering'); ?>
	...
	<thead>
			...
			<th class="title">
					<?php echo JHTML::_('jdgrid.sort', JText::_('PACKAGENAME'), 'i.name', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
			</th>
			<th width="100">
					<?php echo JText::_('PERIOD'); ?>
			</th>
            <th width="100">
					<?php echo JHTML::_('jdgrid.sort', JText::_('ITEMS'), 'i.items', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
			</th>
			<th width="200" align="left">
				<?php echo JHTML::_('jdgrid.sort', JText::_('ACTIONS'), 'i.ordering', @$this->lists['order_Dir'], @$this->lists['order'], null, JText::_('CLICKHERESHORTORDER') ); ?>
