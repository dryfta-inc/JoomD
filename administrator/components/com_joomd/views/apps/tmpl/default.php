...
<form action="index.php?option=com_joomd&view=apps" method="post" name="adminlist">
...
<?php $ordering = ($this->lists['order'] == 'ordering'); ?>
	...
	<thead>
			...
			<th align="left">
				<?php echo JHTML::_('jdgrid.sort', JText::_('NAME'), 'name', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
			</th>
            <th align="left" width="100">
				<?php echo JHTML::_('jdgrid.sort', JText::_('TYPE'), 't.name', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
			</th>
			<th width="150" align="left">
				<?php echo JHTML::_('jdgrid.sort', JText::_('ACTIONS'), 'ordering', @$this->lists['order_Dir'], @$this->lists['order'], null, JText::_('CLKHSBYORD') ); ?>
                <?php echo JHTML::_('jdgrid.order',  'saveorder', $ordering ); ?>
			</th>
            <th width="20" align="left">
				<?php echo JHTML::_('jdgrid.sort', 'ID', 'id', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
			</th>
	</thead>
	...
	<tfoot>
		<tr><td colspan="6"><div class="pagination" style="display:<?php echo $dis; ?>"><?php echo JHTML::_('jdgrid.loadmore', JText::_('LMORE'), $this->params->total, count($this->items) ); ?></div></td></tr>
	</tfoot>
